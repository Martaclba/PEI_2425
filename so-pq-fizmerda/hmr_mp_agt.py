...
nomes_colunas = ['Regiao', 'Empresa', 'Medicamento', 'Mes']

# Ler o ficheiro Excel a partir da linha 11, ignorando o cabeçalho original, e definindo os nomes das colunas
df = pd.read_excel('hmR_MyPharma_Agosto.xlsx',sheet_name='Total Mypharma Regiões',dtype=str, names=nomes_colunas)
...
# Converter Mes para tipo inteiro
for mes in ['Mes']:
