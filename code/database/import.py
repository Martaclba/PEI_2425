...
# Paths
detector_script = "detetor_hmr_mp.py"
input_file = "hmR_MyPharma_Agosto.xlsx"
cleaned_csv = "output.csv"
registry_date= datetime(datetime.now().year,8,1)
# Step 1: Run detector.py to validate the file
...
# Step 2: Load the cleaned CSV (generated by detector.py)
