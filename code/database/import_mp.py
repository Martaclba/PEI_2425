...
try:
    subprocess.run(['c:\\Users\\Marta\\Desktop\\pei-2425\\code\\myenv\\Scripts\\python.exe', input_file, args.path], check=True)
...
cleaned_csv = "../api/output.csv"                            # File generated by detetor_hmr_mp.py
