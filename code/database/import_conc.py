...
cleaned_csv = find_most_recent_csv(".")  # File generated by detetor.py
...
if month  >= 4 :
    dates = {
    "Mes1": datetime(current_year, month-3, 1),  # July
    "Mes2": datetime(current_year, month-2, 1),  # August
    "Mes3": datetime(current_year, month-1, 1)   # September
}
if month  == 1 :
    dates = {
        "Mes1": datetime(current_year-1, 10, 1),  # October
        "Mes2": datetime(current_year-1, 11, 1),  # November
        "Mes3": datetime(current_year-1, 12, 1)   # December
    }
if month  == 2 :
    dates = {
        "Mes1": datetime(current_year-1, 11, 1),  # November
        "Mes2": datetime(current_year-1, 12, 1),  # December
        "Mes3": datetime(current_year, month-1, 1)   # January
    }
if month  == 3 :
    dates = {
        "Mes1": datetime(current_year-1, 12, 1),  # December
        "Mes2": datetime(current_year, month-2, 1),  # January
        "Mes3": datetime(current_year, month-1, 1)   # February
    }
